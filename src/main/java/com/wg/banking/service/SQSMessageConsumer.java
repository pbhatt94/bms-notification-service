...
public class SQSMessageConsumer {
    ...
    public SQSMessageConsumer(AmazonSQS amazonSQSClient) {
    ...
    public void consumeMessages() {
        try {
            ...
            if (!receiveMessageResult.getMessages().isEmpty()) {
                ...
                log.info("Read following Message from queue: {}", message.getBody());
                System.out.println("Read following Message from queue: {}" +  message.getBody());
